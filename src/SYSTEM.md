...
A headless host that loses its default route stays dark until someone notices. The watchdog timer checks every minute and pokes whichever network manager is actually running.
